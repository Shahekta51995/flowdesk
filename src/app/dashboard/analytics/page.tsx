...
const SUPESET_URL = process.env.SUPERSET_URL;
  ...
  return (
    ...
    >
      ...
      {payload.map((p: any, i: number) => (
        ...
        >
          {p.name}:{" "}
          {p.value > 1000 ? `₹${(p.value / 100000).toFixed(1)}L` : p.value}
        </p>
      ))}
    </div>
  );
      ...
      >
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
              ...
              <div>
                ...
                >
                  Published TPC-H benchmarks at scale — columnar OLAP vs
                  row-based RDBMS
                </p>
              </div>
            </div>
                ...
                {performanceData.map((d) => (
                  <button
                    ...
                    style={{
                      ...
                      border: "1px solid",
                      borderColor:
                        activeRows === d.rows ? "#6366f1" : "#2a2d3e",
                      backgroundColor:
                        activeRows === d.rows ? "#6366f120" : "transparent",
        ...
        {/* <div
            ...
            >
              ...
              >
                StarRocks is {Math.round(selected.mysql / selected.starrocks)}x
                faster than MySQL on {activeRows} — TPC-H OLAP benchmark
              </p>
            </div>
          </div>
        </div> */}
        {/* ── MongoDB → StarRocks Sync Panel ── */}
        <div
          style={{
            borderRadius: "12px",
            backgroundColor: "#1a1d27",
        ...
        >
          <div>
            <p style={{ fontSize: "14px", fontWeight: 700, color: "#ffffff" }}>
              🔄 MongoDB → StarRocks Sync
            </p>
            <p style={{ fontSize: "12px", color: "#8b8fa8", marginTop: "4px" }}>
              Pull latest data from MongoDB into StarRocks for analytics
            </p>
            {syncResult && (
              <p
                style={{
              ...
              >
                {syncResult.success
                  ? `✅ Synced ${syncResult.sync.customers.synced} customers
             and ${syncResult.sync.payments.synced} payments`
                  : `❌ ${syncResult.error}`}
              </p>
            )}
          </div>
          ...
          <button
            ...
            style={{
              ...
              padding: "10px 20px",
              borderRadius: "10px",
              backgroundColor: syncing ? "#2a2d3e" : "#6366f1",
              border: "none",
              color: "#ffffff",
              fontSize: "13px",
              fontWeight: 700,
